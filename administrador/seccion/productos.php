...
include("../config/bd.php");
 ...
 $sentenciaSQL->execute();
 $listaLibros=$sentenciaSQL->fetchAll(PDO::FETCH_ASSOC);  //Metodo recupera los registro por asociacion 
    ...
    <table class="table table-bordered">
        ...
        <?php foreach($listaLibros as $libro) {?>
            ...
            <tr>
                ...
                <td> <img class="img-thumbnail rounded" src="../../img/<?php echo $libro['imagen'] ?>" width="100px" alt=""> </td>
                <td>
